...
public class RulesWorkItemHandler implements WorkItemHandler, Cacheable {
	...
	public RulesWorkItemHandler(String releaseIdStr) {
		...
		System.out
				.println("Started KieScanner for releaseId : " + releaseIdStr);
	}
	...
	public void executeWorkItem(WorkItem workItem, WorkItemManager manager) {
		...
		if (kieSessionName == null || kieSessionName.isEmpty()) {
			System.out
					.println("***** WARNING ********:  value for servicetask parameter kieSession is not found!!!!  Check the data inputs assignments for your service task");
